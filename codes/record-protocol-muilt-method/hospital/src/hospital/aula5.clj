...
(let [particular {:id 15, :nome "Guilherme", :nascimento "3/9/1981", :situacao :urgente}
      plano {:id 15, :nome "Matheus", :nascimento "3/9/1981", :situacao :urgente, :plano [:raio-x]}]
...
(let [particular {:id 15, :nome "Guilherme", :nascimento "3/9/1981", :situacao :normal}
      plano {:id 15, :nome "Matheus", :nascimento "3/9/1981", :situacao :normal, :plano [:raio-x]}]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular, :valor 1000, :procedimento :coleta-de-sangue}))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano, :valor 1000, :procedimento :coleta-de-sangue})))
